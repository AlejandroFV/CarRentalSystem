		...
		<div class="wrapper col5">
			<div id="container">
				<div id="content">
					...
					<h1>¿Está seguro qe desea <strong>modificar</strong> este local con los valores proporcionados abajo?</h1>
					<br class="clear">
					<div id="center">
						<?php
							$idLocation = $_GET['ID'];
							...
							mysqli_close($con);
						?>
						<form id=altaCar action="../layout/php/modificarLocationScript.php" method="post">
							...
							<input type="text" id="name_location" name="name_location" size="50" value = '<?php echo $values[1] ?>'><br>
							
							<label for="capacity_location">Capacidad del local:</label><br>
							<input type="text" id="capacity_location" name="capacity_location" size="1" value = '<?php echo $values[2] ?>' ><br>
